This repository contains the Mathematica implementation of the algorithm presented in the paper titled "An algorithm for computing the singularities of the plane model of  $X_0(N)$".
